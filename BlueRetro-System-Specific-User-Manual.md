...
# SNES
## Multitap Config
* **None**: BlueRetro will emulate the device selected in output 1 config on SNES port 1.\
        BlueRetro will emulate the device selected in output 2 config on SNES port 2.
* **Slot 1**: **TBD** ~~BlueRetro will emulate a Super Multitap with 4 controllers on port 1.~~
* **Slot 2**: BlueRetro will emulate a Super Multitap with 4 controllers on port 2.
